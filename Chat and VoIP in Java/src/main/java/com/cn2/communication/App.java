...
public class App extends Frame implements WindowListener, ActionListener {
	...
	public static void main(String[] args){
		 ...
		 */
        App app = new App("SERVER");// TODO: You can add the title that will displayed on the Window of the App here
        app.setSize(500, 250);
        app.setVisible(true);

        try {
            remoteAddress = InetAddress.getByName("0.0.0.0"); // Replace with the actual remote IP
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == sendButton) {
            ...
            try { //(pulse code modulation, 8000 samples/sec, 8 bits and signed samples, single voice channel
                AudioFormat format = new AudioFormat(44100, 16, 1, true, false);//8000, 8, 1, true, true
    ...
    */
    private static String encrypt(String message) throws Exception {
        ...
        Key key = new SecretKeySpec(SECRET_KEY.getBytes(), "AES"); //converse from a byte array to a key for AES
...
/*
MULTITHREADING is used in order to achieve simultaneous fuctionality without delays

UDP SOCKETS are preferred because of low delay and simplicity

AES ENCRYPTION ensures that text messages are secure during transmission
