% ΘΕΜΑ 3 - ΜΕΘΟΔΟΣ ΜΕΓΙΣΤΗΣ ΚΑΘΟΔΟΥ με ΠΡΟΒΟΛΗ
% για αρχικό σημείο (-5, 10)
...
initial_point = [-5, 10]; % Αρχικό σημείο
sk = 15; % Σταθερό βήμα sκ της μεθ. Μέγιστης Καθόδου
gk = 0.1; % Σταθερό βήμα γκ της μεθ. Εφικτών Κατευθύνσεων για την προβολή
