% ΘΕΜΑ 2 - ΜΕΘΟΔΟΣ ΜΕΓΙΣΤΗΣ ΚΑΘΟΔΟΥ με ΠΡΟΒΟΛΗ
% για αρχικό σημείο (5, -5)
...
initial_point = [5, -5]; % Αρχικό σημείο
sk = 5; % Σταθερό βήμα sκ της μεθ. Μέγιστης Καθόδου
gk = 0.5; % Σταθερό βήμα γκ της μεθ. Εφικτών Κατευθύνσεων για την προβολή
epsilon = 0.01; % Ακρίβεια
lower_bounds = [-10, -8];
upper_bounds = [5, 12];
max_iter=40; % Ο αλγόριθμος δεν τερματίζει χωρίς αυτή τη μεταβλητή
